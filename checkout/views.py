        ...
        if order_form.is_valid():
            ...
            for item_key, item_data in bag.items():
                try:
                    ...
                    # Buscar a instância do Flavor
                    flavor_name = item_data.get('flavor', '')
                    flavor_instance = None
                    if flavor_name:
                        try:
                            flavor_instance = Flavor.objects.get(name=flavor_name)
                        except Flavor.DoesNotExist:
                            messages.error(request, f"Flavor '{flavor_name}' not found.")
                            order.delete()
                    ...
                    order_line_item = OrderLineItem(
                        ...
                        is_truffled=flavor_instance.is_truffled if flavor_instance else False,
            ...
            # Após o loop que cria os OrderLineItem
            order.update_total()
...
# A função checkout_success permanece inalterada
